module AmmaShippingMethod.Common {
    ...
    export class ShippingMethodCommandService extends CommandService {

        protected dialogService;
        /* @ngInject */
        constructor(AmmaShippingMethodRestService:RestService, AmmaEventEmitterService:EventEmitterService, $q:ng.IQService, SHIPPING_METHOD_BASE_EVENT_NAME:string, $mdDialog) {
            super(AmmaShippingMethodRestService, AmmaEventEmitterService, $q, SHIPPING_METHOD_BASE_EVENT_NAME);
