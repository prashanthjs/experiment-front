module AmmaProductOrder.Common {
    ...
    export class ProductOrderCommandService extends CommandService {

        protected dialogService;
        /* @ngInject */
        constructor(AmmaProductOrderRestService: RestService, AmmaEventEmitterService: EventEmitterService, $q: ng.IQService, PRODUCT_ORDER_BASE_EVENT_NAME: string, $mdDialog) {
            super(AmmaProductOrderRestService, AmmaEventEmitterService, $q, PRODUCT_ORDER_BASE_EVENT_NAME);
