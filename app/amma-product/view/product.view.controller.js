...
(function (AmmaProduct) {
    ...
    (function (View) {
        ...
        var ProductViewController = (function (_super) {
            ...
            /* @ngInject */
            function ProductViewController(AmmaProductCommandService, AmmaMessageService, $stateParams, AmmaGalleryCommandService, $state, $rootScope, $scope, PRODUCT_CONTENT_EVENT_NAME) {
